...
Tali stati sono:
 ...
 Qual'ora il pattern fosse corretto e il tempo non è scaduto, verranno incrementati il numero di lampeggi al prossimo round e lo score. Verrà diminuito il tempo di 500 ms, fino ad avere un tempo minimo di 2 secondi.
